...
| <a id="webpack_bundle-node_modules"></a>node_modules |  Label pointing to the linked node_modules target where the bundler is linked, e.g. <code>//:node_modules</code>.<br><br>For webpack, the following packages must be linked:     webpack, webpack-cli<br><br>For rspack, the following packages must be linked:     @rspack/core, @rspack/cli   |  none |
...
| <a id="webpack_bundle-bundler"></a>bundler |  The bundler to use. Either "webpack" (default) or "rspack".   |  <code>"webpack"</code> |
...
| <a id="webpack_devserver-node_modules"></a>node_modules |  Label pointing to the linked node_modules target where the bundler is linked, e.g. <code>//:node_modules</code>.<br><br>For webpack, the following packages must be linked:     webpack, webpack-cli, webpack-dev-server<br><br>For rspack, the following packages must be linked:     @rspack/core, @rspack/cli, @rspack/dev-server   |  none |
...
| <a id="webpack_devserver-bundler"></a>bundler |  The bundler to use. Either "webpack" (default) or "rspack".   |  <code>"webpack"</code> |
